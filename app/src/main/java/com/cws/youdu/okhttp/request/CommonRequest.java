package com.cws.youdu.okhttp.request;
...
public class CommonRequest {
    ...
    public static Request createPostRequest(String url, RequestParams params, RequestParams headers) {
        ...
        if (params != null) {
            ...
            Set<String> set = params.urlParams.keySet();
            for (String str : set) {
                TLog.i("KEY=" + str + "; VALUE=" + params.urlParams.get(str));
                sb.append(str);
                sb.append("=");
                sb.append(params.urlParams.get(str));
                sb.append("&");
            }
        }
        TLog.i("URL1:" + sb.substring(0, sb.length() - 1));
        // ====================================
